...
var Collector = module.exports = function Collector(opts)
{
	...
	assert(opts.listen && isObject(opts.listen), 'you must pass a host/port or path object in `listen`');
	assert(opts.outputs && isArray(opts.outputs), 'you must pass an array of clients in `outputs`');
...
Collector.prototype.createWebsocketListener = function createWebsocketListener()
{
	...
	var wss = new WebSocketServer({
		...
		{
			if (isFunction(self.options.listen.verifyClient))
