...
InfluxOutput.prototype._write = function _write(chunk, encoding, callback)
{
    // TODO
    // chunk is a json object
    // tranform it into something influx can cope with & write it

    console.log(chunk);
    callback();
    
    // this.client.writePoint(seriesName, point, options, callback);
};
